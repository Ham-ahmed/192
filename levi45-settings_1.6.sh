...
echo -e "${CYAN}"
echo "################################################################"
echo "#    Start downloading and installing levi45-settings_1.6      #"
echo "################################################################"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/192/refs/heads/main/enigma2-plugin-extensions-levi45-settings_1.6_all.ipk"
IPK_NAME="enigma2-plugin-extensions-levi45-settings_1.6_all.ipk"
