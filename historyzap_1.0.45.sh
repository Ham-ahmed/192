...
echo -e "${CYAN}"
echo "################################################################"
echo "#     Start downloading and installing historyzap_1.0.45       #"
echo "################################################################"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/192/refs/heads/main/enigma2-plugin-extensions-historyzap_1.0.45_all.ipk"
IPK_NAME="enigma2-plugin-extensions-historyzap_1.0.45_all.ipk"
