...
echo -e "${CYAN}"
echo "################################################################"
echo "#         Start downloading and installing panelaio_9.0        #"
echo "################################################################"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/192/refs/heads/main/enigma2-plugin-extensions-panelaio_9.0_all.ipk"
IPK_NAME="enigma2-plugin-extensions-panelaio_9.0_all.ipk"
