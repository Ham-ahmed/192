...
echo -e "${CYAN}"
echo "################################################################"
echo "#     Start downloading and installing xmlupdatebyiet5_1.2     #"
echo "################################################################"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/192/refs/heads/main/enigma2-plugin-extensions-xmlupdatebyiet5_1.2_all.ipk"
IPK_NAME="enigma2-plugin-extensions-xmlupdatebyiet5_1.2_all.ipk"
