...
echo -e "${CYAN}"
echo "################################################################"
echo "#        Start downloading and installing xstreamity_5.31       #"
echo "################################################################"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/192/refs/heads/main/enigma2-plugin-extensions-xstreamity_5.31.20260215_all.ipk"
IPK_NAME="enigma2-plugin-extensions-xstreamity_5.31.20260215_all.ipk"
